...
// use Suxianjia\xianjia_short_code\fun::check_blacklist()
class fun { 

    public static  function fun(): string
{
    return "fun";
}
...
//// use Suxianjia\xianjia_short_code\fun::check_blacklist()
    public static function check_blacklist($string,$blacklist)
{
//    global $blacklist;
...
// check_scan_url
    public static  function check_scan_url($url = '' ,$config = []) :bool|array|string
{
    $result = false;
